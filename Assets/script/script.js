...
function beachwave() {
  document.querySelector(".beach__big-wave").src =
    "Assets/img/bigmouthfull.svg";
  document.querySelector(".beach__trash").classList.add("beach__trash--hidden");
  document
    .querySelector(".panel3__text2")
    .classList.remove("panel3__text2--hidden");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const scene2Height = document
    .querySelector(".scene2")
